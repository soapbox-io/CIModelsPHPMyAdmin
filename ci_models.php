...
if (isset($plugin_list)) {
    ...
    $GLOBALS['cfg']['Export']['ci_models_verbose'] = true;
    $GLOBALS['cfg']['Export']['ci_models_index'] = false;
    $GLOBALS['cfg']['Export']['ci_models_relation'] = true;
    ...
    function handleCodeIgniterPHPBody($db, $table, $crlf)
    {
        ...
        if ($result)
        {
            ...
            $filename = '../../htdocs/models/'. toCamelCase( $table, true ) . '_model.php';
            $content = implode("\n", $lines);
            $fp = fopen($filename, 'w');
        ...
        return '/htdocs/models/'. toCamelCase( $table, true ) . '_model.php   ';
